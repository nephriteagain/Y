        ...
        <View className="gap-y-4 px-4 mt-auto"> 
            ...
            >
                ...
                >
                    <List.Item 
                    title="Ads"
                    left={() => <FontAwesome6 name="arrow-up-right-from-square" size={18} color="black" />}
                ...
                >
                    ...
                    left={() => <Feather name="settings" size={24} color="black" />}
                    titleStyle={{fontSize: 14}}
                    style={{paddingStart: 16}}
                    ...
                    <List.Item 
                    title="Help Center" 
                    left={() => <Ionicons name="help-circle-outline" size={24} color="black" />}
                    titleStyle={{fontSize: 14}}
                    style={{paddingStart: 16}}
