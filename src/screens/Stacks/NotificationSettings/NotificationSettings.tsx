...
export default function NotificationSettings() {
    return (
        <View className="p-4 gap-y-4">
            <View>
                <Text style={{fontWeight: 'bold'}}>Select the kinds of notification you get about your activities, interests, and recommendations.</Text>
            </View>
            <View className="gap-x-2 gap-y-6">
                <View className="flex-row">
                    ...
                    <View className="basis-5/6">
                        <View>
                            ...
                            <Text>Choose the notification you'd like to see</Text>
                ...
                <View className="flex-row justify-center">
                    ...
                    <View className="basis-5/6">
                        ...
                        <Text>Select your preferences by notification type.</Text>
                    </View>
                </View>
            </View>
        </View>
