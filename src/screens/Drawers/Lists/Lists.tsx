        ...
        <View className="py-4 relative">
            <ScrollView className="gap-y-4 px-4">
                <View className="gap-y-4">
                    ...
                    <View
                        style={{ height: 120 }}
                        className="items-center justify-center px-8 bg-gray-200 rounded-lg"
                    >
                ...
                <View>
                    <Text className="font-bold pb-8" style={{ fontSize: 20 }}>
                        Discover new Lists
                    </Text>
                    <ScrollView className="gap-y-6">
                        {fakeLists.map(
                            ({ id, members, followers, inc, name }) => {
                                return (
                                    <View
                                        key={id}
                                        className="flex-row gap-x-2 justify-between items-center"
                                    >
                                        <View>
                    ...
                    <Text
                        className="pt-4 font-semibold text-blue-600"
                        style={{ fontSize: 16 }}
                    >
                        Show more
                    </Text>
